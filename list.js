...
Cons.prototype.append = function(x) {
...
Cons.prototype.filter = function(x) {
    if(x(this.head)) {
        return new Cons(this.head, this.tail.filter(x));
    }
    return this.tail.filter(x);
};
...
Nil.prototype.contains = function(x) {
    return false;
};
Nil.prototype.append = function(x) {
    return x; 
};
Nil.prototype.map = function(fn) {
    return this;
}
